    ...
    <div id='Profile' className='vh-100'>
      ...
      <div className='mt-md-5 position-relative py-4 container d-flex flex-column flex-md-row pt-5 align-items-center align-items-md-start justify-content-center justify-content-md-around'>
        <div className=' col-md-3 col-lg-3'>
          ...
          <div>
            <p className='d-none text-center d-md-block mt-4 fs-5'>
        ...
        <div className=' col-10 col-md-6'>
          ...
          <form
            ...
            className='d-flex flex-column p-4 p-md-5 rounded'
            style={{ background: 'white' }}>
            <input
              className='mb-3 py-2 py-md-3 px-2'
              type='text'
            ...
            />
            <DatePicker
              className='mb-3 py-2 py-md-3 px-2 w-100'
            ...
            <div className='d-flex justify-content-center gap-3'>
              <Link to='/'>
                <button className='bg-transparent border-0 py-2 py-md-3 fw-bold text-Pr'>
                  CANCEL
                </button>
              </Link>
              <button
