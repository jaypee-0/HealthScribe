  ...
  return (
    <div className='vh-100' style={{ backgroundColor: "#F5F5F5" }}>
      ...
      <h3 className="text-center d-none d-md-block mb-4">Create your profile</h3>
          ...
          <DatePicker className="mb-3 py-2 py-md-3 px-2 rounded border border-1 w-100" placeholderText="mm/dd/yyyy" selected={startDate} onChange={(date:any) => setStartDate(date)} />
          ...
          <div className="d-flex justify-content-center gap-3">
            ...
            <Button title={'SAVE'} url={'/timeline'} bg={false} color={false} border={true} />
          </div>
          </form>
        </div>
      </div>
