    ...
    <div className="vh-100" style={{backgroundColor: "#F5F5F5"}}>
      <SignUpNavbar />
        <div
          ...
          <button className="border py-3 mb-4 bg-light px-5 justify-content-center gap-md-4 d-flex align-items-center rounded border-2" style={{width: widthsize <= 575 ? '300px' : '500px'}} >
            <img src={google} alt="" />
            <p className="mb-0 ms-3">Sign up with Google</p>
          </button>
          <button className="border py-3 bg-light px-5 justify-content-center gap-md-4 d-flex align-items-center rounded border-2" style={{width: widthsize <= 575 ? '300px' : '500px'}} >
